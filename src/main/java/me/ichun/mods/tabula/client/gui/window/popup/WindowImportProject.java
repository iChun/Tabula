...
public class WindowImportProject extends Window<WorkspaceTabula>
{
    ...
    public static class ViewOpenProject extends View<WindowImportProject>
    {
        public ViewOpenProject(@Nonnull WindowImportProject parent)
        {
            ...
            ElementButton<?> button1 = new ElementButton<>(this, I18n.format("gui.done"), btn ->
            {
