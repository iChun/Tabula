                        ...
                        for(AnimationComponent comp : e.getValue())
                        {
                            if(idClicked == idHovered)
                            {
                                if(comp.startKey == mousePos)
                                {
                                    ...
                                    sb.append(I18n.translateToLocal("window.editAnimCompProg.animInfo") + "\n");
                                    sb.append(I18n.translateToLocal("window.controls.position") + ": ");
                                    ...
                                    sb.append(I18n.translateToLocal("window.controls.rotation") + ": ");
                                    ...
                                    sb.append(I18n.translateToLocal("window.controls.scale") + ": ");
                                    ...
                                    sb.append(I18n.translateToLocal("window.controls.opacity") + ": ");
