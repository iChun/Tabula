...
public class ElementProjectButton extends ElementClickable<Fragment<?>>
{
    public @Nonnull String text;

    public ElementProjectButton(@Nonnull Fragment<?> parent, String s, Consumer<ElementClickable<? extends Fragment<?>>> callback)
    {
