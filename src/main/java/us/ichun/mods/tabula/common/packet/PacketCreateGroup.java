...
public class PacketCreateGroup extends AbstractPacket
{
    public String host;
    public String ident;

    public PacketCreateGroup(){}

    public PacketCreateGroup(String host, String ident)
    {
        this.host = host;
        this.ident = ident;
    }
    ...
    public void handleClient()
    {
        ...
        {
            Tabula.proxy.tickHandlerClient.mainframe.createNewGroup(ident);
        }
    }
}
