...
public class PacketLoadEmptyProject extends AbstractPacket
{
    public String host;
    ...
    public PacketLoadEmptyProject(){}

    public PacketLoadEmptyProject(String host, String projName, String authName, int txWidth, int txHeight, double scaleX, double scaleY, double scaleZ)
    {
        this.host = host;
    ...
    public void handleClient()
    {
        ...
        {
            Tabula.proxy.tickHandlerClient.mainframe.loadEmptyProject(projName, authName, txWidth, txHeight, scaleX, scaleY, scaleZ);
        }
    }
}
